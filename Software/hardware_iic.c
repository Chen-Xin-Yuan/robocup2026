...
#define GRAY_IIC_TIMEOUT_MS 10U

// static uint8_t gray_iic_read_register(uint8_t register_address,
//                                       uint8_t *data,
//                                       uint16_t length)
// {
...
//     if (gray_iic_read_register(GW_GRAY_PING, &response, 1U) != 0U) {
//         return 1U;
//     }

//     return (response == GW_GRAY_PING_OK) ? 0U : 1U;
// }

// uint8_t Gray_IIC_GetDigital(uint8_t *digital_value)
// {
//     return gray_iic_read_register(GW_GRAY_DIGITAL_MODE,
//                                   digital_value,
//                                   1U);
// }
